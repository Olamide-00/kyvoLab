        ...
        <div className="page-hero-in">
          <Reveal>
            <div className="hero-eye">
              ...
              <span style={{ fontFamily: "Fira Code, monospace" }}>work.list()</span>
            </div>
          </Reveal>
          <Reveal delay={80}>
          ...
          <Reveal delay={150}>
            <p className="page-sub">
              Real products, real screens — each one a full rebrand, redesign, or ground-up
              interface build for a fintech client.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <div className="work-grid">
            {PROJECTS.map((p, i) => (
              <Reveal key={p.slug} delay={i * 90}>
                <Link to={`/work/${p.slug}`} className="work-card" style={{ ["--accent" as string]: p.accent }}>
                  ...
                  <div className="work-card-body">
                    <div className="work-card-top">
                      ...
                      {p.status === "in-progress" && <span className="status-pill">in progress</span>}
                    </div>
                    <div className="feat-card-title" style={{ fontSize: 26 }}>{p.name}</div>
